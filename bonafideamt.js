...
$('#download').click(function(){
 ...
 console.log(purpose);
if(purpose=="Scholarship" || purpose=="Fees Paid Certificat" || purpose=="Education Loan"){
	amount = $( '#amount' ).val();	
	console.log('if');
	$.ajax({
            type:"POST",
...
doc.setFont('helvetica')
doc.setFontSize(18)
doc.text(68, 28, 'Faculty of Engineering & Technology')
doc.setFont('helvetica')
...
doc.text(165, 66, 'xxxx/xxxx/xxxx')
doc.setFont('helvetica')
doc.setFontType('bold')
doc.setFontSize(22)
...
var purpose = $( 'input[name=optradio]:checked' ).val();
console.log(purpose);
doc.text(80, 210,purpose)
})	
///////////////////////////////////////
...
//b64 contains the base64 url of QR code
 convertImgToBase64(imageUrl, function(base64Img){
		doc.addImage(base64Img, 'JPEG', 155, 240)
    });
	///////////////////////////////////////////////////

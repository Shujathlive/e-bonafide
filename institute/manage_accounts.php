...
$insId=$row[0];
		...
		$sql="SELECT campusId,accountsUsername,accountsPassword FROM accounts WHERE instituteId = $insId ";
		$res=mysqli_query($conn,$sql);
		...
		echo" <tr id=".$row[0]."><td>";
			...
			echo '</td>
			<td id="country_row2" class="input-field"><input type="text" name="id[]" value="'.$row[0].'" readonly></td>
			<td id="country_row1" class="input-field"><input type="text" name="uname[]" value="'.$row[1].'"></td>
			<td id="age_row1" class="input-field"><input type="text" name="pwd[]" value="'.$row[2].'" ></td>

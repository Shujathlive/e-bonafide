	  ...
	  <div class="container">
		...
		<br>
		    <div class="row center">
				  ...
				  <form action="upload_csv_data.php" method="post" enctype="multipart/form-data" id="importFrm">
			...
			<center>	
				...
				<button class="waves-effect waves-light btn green" type="submit" id="upload" name="importSubmit">Upload</button>
							<a class="waves-effect waves-light btn btn-floating  pulse blue btn tooltipped" data-position="right" data-delay="50" data-tooltip="Sample CSV file" href="CSV/studData.csv"><i class="material-icons" download>live_help</i></a></center>

  ...
  main {
    ...
    <main>
	  ...
	  <div class="container">
		...
		?>
			<input id="amount" name="amount" type="text" class="validate" disabled required>
	...
	$('input[name=optradio]').change(function(){
		if ($("input[name=optradio]:checked").val() == "Scholarship" || $("input[name=optradio]:checked").val() == "Fees Paid Certificat"|| $("input[name=optradio]:checked").val() == "Education Loan") {
 $("#amount").attr("disabled", false);  //selector is wrong.
}
else{
	$("#amount").attr("disabled", true);  //selector is right.
}
	});

  ...
  main {
    ...
    <main>
	  ...
	  <div class="container">
		...
		<br>
		<br>
		<button class="waves-effect waves-light btn green" id="download"  onclick="clicked('CC')" >REQUEST</button>
		</div>
	  </form>
		...
		<div class="row">
          ...
          <div class="card">
            <div class="card-content">
              <span class="card-title">Course Completion Certificate</span>
			  <table class="center">
        <thead>
          <tr>
	          <th>Date & Time</th>
...
$ctable='campus_'.$iID.$cID;
 $sql="SELECT certificateNo,activate,created_at FROM $ctable WHERE regNo='$regNo' AND certificate='CC'";
